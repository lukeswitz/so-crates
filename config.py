...
# Live capture (user-initiated only - see live_capture.py)
CAPTURE_DEFAULT_DURATION = 60              # seconds pre-filled in the Capture dialog
CAPTURE_MAX_DURATION = 3600                # 1 hour ceiling on a single capture
