...
- **Add theme overrides** in the appropriate `[data-theme="..."]` block (e.g., `light`, `sguil`, `hacker`, `cga`, `breadbin-blue`, `vaporwave`, `matte-black`, `tokyo-night`, `retro-82`, `ethereal`, `lumon`, `catppuccin`, `catppuccin-latte`, `everforest`, `gruvbox`, `hackerman`, `kanagawa`, `miasma`, `nord`, `osaka-jade`, `ristretto`, `rose-pine`, `vantablack`, or `white`) when a default dark color lacks contrast or does not match the theme's aesthetic.
